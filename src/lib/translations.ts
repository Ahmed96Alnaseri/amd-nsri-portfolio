...
export const translations = {
  EN: {
    ...
    platform: {
      ...
      headingLine1:  'The drawing is a promise.',
      headingPre:    'The fabrication is the ',
      headingSystem: 'proof',
      body1:         'Every geometry we produce is resolved against one question: can this actually be built? Panel division, bend radius, tolerance stack, assembly sequence — these are not afterthoughts. They are the design.',
      body2:         'AMD NSRI works at the point where architectural intent meets production reality. Not one or the other. The distance between them — أَمَد — is where the practice lives.',
    ...
    eco: {
      ...
      subhead: 'Five connected directions — each a distinct framework through which AMD NSRI approaches design, computation, and fabrication.',
      enter:   'Enter',
    ...
    contact: {
      ...
      subjToolQuote:     'Tool Quote',
      subjOther:         'Other',
      errRequired:       'Required',
      errInvalidEmail:   'Invalid address',
      errSend:           'Could not send — please try again or email directly.',
      send:              'Send Message',
      sending:           'Sending',
    ...
    about: {
      ...
      stmtBody:        'The independent practice of Ahmed Alnaseri, an Iraqi architect in Istanbul — closing the gap between architectural imagination and built reality.',
      nameAmdPre:      '— from Ahmed, and from ',
      nameAmdPost:     '.',
      nameNsri:        '— from Alnaseri.',
      ...
      disc1Body:       'Parametric systems and automation that make one-off problems repeatable.',
      disc2Title:      'Facade Engineering',
      disc2Body:       'Panelization, substructure and tolerance — the skin as a buildable system.',
      disc3Title:      'Fabrication Intelligence',
      disc3Body:       'Unfolding and shop drawings — design carried to the workshop file.',
  ...
  TR: {
    ...
    platform: {
      ...
      headingLine1:  'Çizim bir vaattir.',
      headingPre:    'Üretim ise ',
      headingSystem: 'kanıttır',
      body1:         'Ürettiğimiz her geometri tek bir soruya göre çözümlenir: bu gerçekten inşa edilebilir mi? Panel bölümü, bükme yarıçapı, tolerans yığını, montaj sırası — bunlar sonradan düşünülen şeyler değildir. Tasarımın kendisidir.',
      body2:         'AMD NSRI, mimari niyetin üretim gerçekliğiyle buluştuğu noktada çalışır. Biri ya da diğeri değil. İkisi arasındaki mesafe — أَمَد — pratiğin yaşadığı yerdir.',
      specTitle:     'Şartname',
    ...
    eco: {
      ...
      subhead: 'Beş bağlantılı yönelim — AMD NSRI\'nin tasarım, hesaplama ve fabrikasyona yaklaşımında her biri ayrı bir çerçeve.',
      enter:   'Gir',
    ...
    stats: {
      eyebrow:  'AMD — NSRI',
      title:    'Rakamlarla',
      subtitle: 'Hesaplamalı tasarım, cephe sistemleri ve üretim zekası alanlarında büyüyen bir kayıt.',
      projects: 'Projeler',
      tools:    'Araçlar',
      countries:'Ülkeler',
      clients:  'Müşteriler',
    ...
    contact: {
      ...
      subjToolQuote:     'Araç Fiyat Teklifi',
      subjOther:         'Diğer',
      errRequired:       'Zorunlu',
      errSend:           'Gönderilemedi — lütfen tekrar deneyin veya doğrudan e-posta gönderin.',
    ...
    about: {
      ...
      stmtBody:        'İstanbul’da çalışan Iraklı mimar Ahmed Alnaseri’nin bağımsız pratiği — mimari hayal ile inşa edilmiş gerçeklik arasındaki boşluğu kapatır.',
      nameAmdPre:      '— Ahmed adından ve ',
      nameAmdPost:     ' sözcüğünden.',
      nameNsri:        '— Alnaseri soyadından.',
      ...
      disc1Body:       'Sorunları tekrarlanabilir kılan parametrik sistemler ve otomasyon.',
      disc2Title:      'Cephe Mühendisliği',
      disc2Body:       'Panelleme, alt strüktür, tolerans — inşa edilebilir bir kaplama sistemi.',
      disc3Title:      'Fabrikasyon Zekâsı',
      disc3Body:       'Açınım ve atölye çizimleri — tasarım atölye dosyasına kadar.',
  ...
  AR: {
    ...
    platform: {
      ...
      headingLine1:  'الرسم وعدٌ.',
      headingPre:    'التصنيع هو ',
      headingSystem: 'الإثبات',
      body1:         'كل هندسة ننتجها تُحلّ في مواجهة سؤال واحد: هل يمكن بناء هذا فعلاً؟ تقسيم الألواح، نصف قطر الانحناء، تراكم التفاوتات، تسلسل التجميع — هذه ليست أفكاراً لاحقة. إنها التصميم ذاته.',
      body2:         'يعمل AMD NSRI عند النقطة التي تلتقي فيها النية المعمارية بواقع الإنتاج. ليس أحدهما أو الآخر. المسافة بينهما — أَمَد — هي المكان الذي تعيش فيه الممارسة.',
      specTitle:     'المواصفات',
      specVerified:  'جاهز للانتاج',
      specDomainL:   'المجال',
    ...
    eco: {
      ...
      subhead: 'خمسة مسارات مترابطة — كل منها إطار مميز يُجسّد مقاربة AMD NSRI في التصميم والحوسبة والتصنيع.',
      enter:   'ادخل',
      card1Title:    'أَمَد العمارة',
      ...
      card3Tag1: 'كراسوبر', card3Tag2: 'راينو', card3Tag3: 'التقسيم', card3Tag4: 'الذكاء الاصطناعي',
      card4Title:    'أَمَد التصنيع',
    ...
    stats: {
      eyebrow:  'AMD — NSRI',
      title:    'بالأرقام',
      subtitle: 'سجل متنامٍ في التصميم الحسابي وأنظمة الواجهات وذكاء التصنيع.',
      projects: 'مشاريع',
      tools:    'أدوات',
      countries:'دول',
      clients:  'عملاء',
    ...
    contact: {
      ...
      subjToolQuote:     'عرض سعر لأداة',
      subjOther:         'أخرى',
      errRequired:       'مطلوب',
      errSend:           'تعذّر الإرسال — يرجى المحاولة مرة أخرى أو المراسلة مباشرة.',
    ...
    about: {
      ...
      stmtBody:        'الممارسة المستقلة لأحمد الناصري، المعماري العراقي المقيم في إسطنبول — تسدّ الفجوة بين الخيال المعماري والواقع المبني.',
      nameAmdPre:      '— من أحمد، ومن ',
      nameAmdPost:     '.',
      nameNsri:        '— من الناصري.',
      ...
      disc1Body:       'أنظمة بارامترية وأتمتة تجعل المشكلات الفردية قابلة للتكرار.',
      disc2Title:      'هندسة الواجهات',
      disc2Body:       'التقسيم إلى ألواح، والبنية التحتية، والتفاوت — الغلاف كنظام قابل للبناء.',
      disc3Title:      'ذكاء التصنيع',
      disc3Body:       'الفرد ورسومات الورشة — يُحمَل التصميم حتى ملف الورشة.',
      ctaLine1:        'من أول رسم',
